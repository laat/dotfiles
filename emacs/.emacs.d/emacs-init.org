...
** TODO Multiple Cursors
   Does not play nice with evil, and I have no idea how to use
   it. Disabled for now, but must research this more because it is
   freaking awesome-looking.
   
   #+begin_src emacs-lisp
     (use-package multiple-cursors
       :disabled t ;; I do not understand it yet.
       ;;:ensure t
       :init
       (after 'evil
...
** TODO Dash
** TODO Vertikal linje ved 80 tegn
   #+begin_src emacs-lisp :tangle no
     (use-package fill-column-indicator
       :ensure t
       :disabled t ;; company completion?
